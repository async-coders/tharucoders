...
function circleChaptaKaro ()
{
  ...
  window.addEventListener( "mousemove", function ( dets )
  {
    ...
    xscale = gsap.utils.clamp( 3, 3.3, dets.clientX - xprev );
    yscale = gsap.utils.clamp( 3, 3.3, dets.clientY - yprev );
    ...
    timeout = setTimeout( function ()
    {
      document.querySelector(
        "#minicircle"
      ).style.transform = `translate(${ dets.clientX }px, ${ dets.clientY }px) scale(3, 3)`; //changes here 1, 1//
    }, 100 );
  } );
}
